...
#
# Copyright (C) 2016 - 2018 Cyril <i@lia.im>
#
# Thanks: Bench.sh <i@teddysun.com>
#
# URL: https://www.lia.im/
#
...
about () {
	...
	echo " \                   Created by Cyril                  / "
	echo " ========================================================= "
	echo ""
	echo " Intro: https://www.lia.im/"
	echo " Copyright (C) 2018 Cyril <i@lia.im>"
...
benchinit() {
	...
	if  [ ! -e 'ip_info.py' ]; then
		...
		wget http://www.mss.ooo/Shell/ip_info.py > /dev/null 2>&1
	fi
...
print_intro() {
	printf ' Superbench.sh -- https://www.lia.im/\n' | tee -a $log
	printf " Mode  : \e${GREEN}%s\e${PLAIN}    Version : \e${GREEN}%s${PLAIN}\n" $mode_name 1.0.4 | tee -a $log
	printf ' Usage : wget -qO- http://www.mss.ooo/Shell/superbench.sh | bash\n' | tee -a $log
}
